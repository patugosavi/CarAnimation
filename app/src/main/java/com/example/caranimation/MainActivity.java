...
import com.example.caranimation.util.AnimationUtils;
import com.example.caranimation.util.MapUtils;
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                if (index < 10) {
                    ...
                    Toast.makeText(MainActivity.this, "Trip Ends", Toast.LENGTH_SHORT).show();
                }
            }
        };
